...
public class FirebaseUtils {
     ...
     */
    public FirebaseUtils(Context con) {
        mContext = con;
    }
...
//    }
     ...
     *
     * @param sharedWith            The list of users the shopping list that has been updated is
     *                              shared with.
...
//                mapToUpdate.put("/" + Constants.FIREBASE_LOCATION_USER_LISTS + "/" + user
// .getEmail() + "/"
//                        + listId + "/" + propertyToUpdate, valueToUpdate);
//            }
//        }
...
//    }
     ...
     * value.
     *
     * @param firebaseError      The Firebase error, if there was one, from the original update.
     *                           This
     *                           method should only run if the shopping list's timestamp last
     *                           changed
     ...
     */
//    public static void updateTimestampReversed(FirebaseError firebaseError, final String
// logTagFromActivity,
//                                               final String listId, final HashMap<String, User>
// sharedWith,
//                                               final String owner) {
...
//                        String timeReverseLocation = Constants
...
//                         */
//                        HashMap<String, Object> updatedShoppingListData = new HashMap<String,
// Object>();
//
//                        updateMapForAllWithValue(sharedWith, listId, owner,
// updatedShoppingListData,
...
//                    Log.d(logTagFromActivity, "Error updating data: " + firebaseError
// .getMessage());
//                }
//            });
//        }
